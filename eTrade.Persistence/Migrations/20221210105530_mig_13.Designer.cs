...
namespace eTrade.Persistence.Migrations
{
    ...
    [Migration("20221210105530_mig_13")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("eTrade.Domain.Entities.Basket", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("eTrade.Domain.Entities.BasketItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("eTrade.Domain.Entities.Endpoint", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("AppRoleEndpoint", b =>
                {
                    ...
                    b.HasOne("eTrade.Domain.Entities.Endpoint", null)
                        .WithMany()
            ...
            modelBuilder.Entity("eTrade.Domain.Entities.Basket", b =>
                {
                    b.HasOne("eTrade.Domain.Entities.Identity.AppUser", "User")
                        .WithMany("Baskets")
            ...
            modelBuilder.Entity("eTrade.Domain.Entities.Order", b =>
                {
                    b.HasOne("eTrade.Domain.Entities.Basket", "Basket")
                        .WithOne("Order")
                        .HasForeignKey("eTrade.Domain.Entities.Order", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
